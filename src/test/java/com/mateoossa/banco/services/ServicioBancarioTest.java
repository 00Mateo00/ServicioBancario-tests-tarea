...
class ServicioBancarioTest {
    ...
    void configurarEntornoDePrueba() {
        this.banco = new Banco("J.P. Morgan");
    ...
    class DepositarTests {
        ...
        void deberiaAumentarSaldoAlDepositarMontoPositivo() {
            ...
            assertEquals(saldoEsperado, cuentaMateo.getSaldo(),
                    "El saldo de la cuenta debería aumentar después de un depósito positivo.");
        }
        ...
        void deberiaLanzarExcepcionAlDepositarMontoNegativo() {
            ...
            IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                    () -> servicioBancario.depositar(cuentaMateo, montoDeposito),
                    "Se esperaba una IllegalArgumentException al depositar un monto negativo.");
            assertEquals("El monto a depositar debe ser positivo.", exception.getMessage(),
                    "El mensaje de la excepción para monto de depósito negativo debería ser correcto.");
        }
        ...
        void deberiaLanzarExcepcionAlDepositarCero() {
            ...
            IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                    () -> servicioBancario.depositar(cuentaMateo, montoDeposito),
                    "Se esperaba una IllegalArgumentException al depositar cero.");
            assertEquals("El monto a depositar debe ser positivo.", exception.getMessage(),
                    "El mensaje de la excepción para depositar cero debería ser correcto.");
        }
        ...
        void deberiaLanzarNullPointerExceptionAlDepositarEnCuentaNula() {
            ...
            assertThrows(NullPointerException.class,
                    () -> servicioBancario.depositar(cuentaNula, montoDeposito),
                    "Se esperaba una NullPointerException al depositar en una cuenta nula con la implementación actual.");
        }
    }
    ...
    class RetirarTests {
        ...
        void deberiaDisminuirSaldoAlRetirarMontoPositivoConSaldoSuficiente() {
            ...
            assertEquals(saldoEsperado, cuentaMateo.getSaldo(),
                    "El saldo de la cuenta debería disminuir después de un retiro positivo.");
        }
        ...
        void deberiaLanzarExcepcionAlRetirarMontoNegativo() {
            ...
            IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                    () -> servicioBancario.retirar(cuentaMateo, montoRetiro),
                    "Se esperaba una IllegalArgumentException al retirar un monto negativo.");
            assertEquals("El monto a retirar debe ser positivo.", exception.getMessage(),
                    "El mensaje de la excepción para monto de retiro negativo debería ser correcto.");
        }
        ...
        void deberiaLanzarExcepcionAlRetirarCero() {
            ...
            IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                    () -> servicioBancario.retirar(cuentaMateo, montoRetiro),
                    "Se esperaba una IllegalArgumentException al retirar cero.");
            assertEquals("El monto a retirar debe ser positivo.", exception.getMessage(),
                    "El mensaje de la excepción para retirar cero debería ser correcto.");
        }
        ...
        void deberiaLanzarSaldoInsuficienteExceptionAlRetirarSinSaldo() {
            ...
            assertEquals("El saldo es insuficiente", exception.getMessage(),
                    "El mensaje de la excepción de saldo insuficiente debería ser correcto.");
            assertEquals(saldoAntesDeRetiro, cuentaMateo.getSaldo(),
                    "El saldo de la cuenta no debería cambiar si la operación de retiro falla por saldo insuficiente.");
        }
        ...
        void deberiaDejarSaldoEnCeroAlRetirarExactamenteElSaldo() {
            ...
            servicioBancario.retirar(cuentaMateo, montoRetiro);
            assertEquals(saldoEsperado, cuentaMateo.getSaldo(),
                    "El saldo de la cuenta debería ser cero después de retirar el saldo completo.");
        }
        ...
        void deberiaLanzarNullPointerExceptionAlRetirarDeCuentaNula() {
            ...
            Cuenta cuentaNula = null;
            assertThrows(NullPointerException.class,
                    () -> servicioBancario.retirar(cuentaNula, montoRetiro),
                    "Se esperaba una NullPointerException al retirar de una cuenta nula con la implementación actual.");
        }
    }
    ...
    class ConsultarEstadoTests {
        ...
        void deberiaRetornarRepresentacionEnCadenaDeLaCuenta() {
            ...
            assertEquals(estadoEsperado, estadoActual,
                    "El estado consultado debería coincidir con la representación en cadena de la cuenta.");
        }
        ...
        void deberiaLanzarNullPointerExceptionAlConsultarEstadoDeCuentaNula() {
            Cuenta cuentaNula = null;
            assertThrows(NullPointerException.class,
                    () -> servicioBancario.consultarEstado(cuentaNula),
                    "Se esperaba una NullPointerException al consultar estado de una cuenta nula con la implementación actual.");
        }
    }
    ...
    class TransferirTests {
        ...
        void deberiaTransferirMontoCorrectamenteEntreCuentas() {
            ...
            assertEquals(saldoEsperadoMateo, cuentaMateo.getSaldo(),
                    "El saldo de la cuenta de origen (Mateo) debería disminuir después de la transferencia.");
            assertEquals(saldoEsperadoBelen, cuentaBelen.getSaldo(),
                    "El saldo de la cuenta de destino (Belen) debería aumentar después de la transferencia.");
        }
        ...
        void deberiaLanzarExcepcionSiCuentaDestinoEsNula() {
            double montoTransferido = 1000.0;
            IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                    () -> servicioBancario.transferir(cuentaMateo, null, montoTransferido),
                    "Se esperaba una IllegalArgumentException al transferir a una cuenta nula.");
            assertEquals("Las cuentas no pueden ser nulas", exception.getMessage(),
                    "El mensaje de la excepción para cuenta de destino nula debería ser correcto.");
        }
        ...
        void deberiaLanzarExcepcionSiCuentaOrigenEsNula() {
            double montoTransferido = 1000.0;
            IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                    () -> servicioBancario.transferir(null, cuentaBelen, montoTransferido),
                    "Se esperaba una IllegalArgumentException al transferir desde una cuenta nula.");
            assertEquals("Las cuentas no pueden ser nulas", exception.getMessage(),
                    "El mensaje de la excepción para cuenta de origen nula debería ser correcto.");
        }
        ...
        void deberiaLanzarExcepcionSiMontoEsNegativo() {
            ...
            IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                    () -> servicioBancario.transferir(cuentaMateo, cuentaBelen, montoTransferido),
                    "Se esperaba una IllegalArgumentException al transferir un monto negativo.");
            assertEquals("El monto a transferir debe ser positivo.", exception.getMessage(),
                    "El mensaje de la excepción al transferir monto negativo debería ser el de depositar.");
            assertEquals(saldoOriginalMateo, cuentaMateo.getSaldo(),
                    "El saldo de la cuenta de origen no debería cambiar si la transferencia falla por monto negativo.");
            assertEquals(saldoOriginalBelen, cuentaBelen.getSaldo(),
                    "El saldo de la cuenta de destino no debería cambiar si la transferencia falla por monto negativo.");
        }
        ...
        void deberiaLanzarExcepcionAlTransferirCero() {
            ...
            IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                    () -> servicioBancario.transferir(cuentaMateo, cuentaBelen, montoTransferido),
                    "Se esperaba una IllegalArgumentException al transferir cero.");
            assertEquals("El monto a transferir debe ser positivo.", exception.getMessage(),
                    "El mensaje de la excepción al transferir cero debería ser el de depositar.");
            assertEquals(saldoOriginalMateo, cuentaMateo.getSaldo(),
                    "El saldo de la cuenta de origen no debería cambiar si la transferencia falla por monto cero.");
            assertEquals(saldoOriginalBelen, cuentaBelen.getSaldo(),
                    "El saldo de la cuenta de destino no debería cambiar si la transferencia falla por monto cero.");
        }
        ...
        void deberiaLanzarSaldoInsuficienteExceptionYNoModificarSaldosSiOrigenSinSaldo() {
            double montoTransferido = cuentaMateo.getSaldo() + 3000.0;
            double saldoOriginalMateo = cuentaMateo.getSaldo();
            double saldoOriginalBelen = cuentaBelen.getSaldo();
            servicioBancario.transferir(cuentaMateo, cuentaBelen, montoTransferido);
            assertEquals(saldoOriginalMateo, cuentaMateo.getSaldo(),
                    "El saldo de la cuenta de origen no debería cambiar si la transferencia falla.");
            assertEquals(saldoOriginalBelen, cuentaBelen.getSaldo(),
                    "El saldo de la cuenta de destino no debería cambiar si la transferencia falla.");
        }
        ...
        void deberiaLanzarExcepcionSiCuentasSonLaMisma() {
            ...
            IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                    () -> servicioBancario.transferir(cuentaMateo, cuentaMateo, montoTransferido),
                    "Se esperaba una IllegalArgumentException al transferir entre la misma cuenta.");
            assertEquals("No se puede transferir a la misma cuenta", exception.getMessage(),
                    "El mensaje de la excepción para cuentas de origen y destino iguales debería ser correcto.");
        }
    }
}